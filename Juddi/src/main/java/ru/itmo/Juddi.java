...
public class Juddi {
    ...
    public static void main(String[] args) {
        ...
        if (agree.equals("y")) {
            ...
            System.out.println("What jUDDI Service Access Point (default: http://localhost:8090/LoyaltyService?wsdl)?");
            String registeredServiceURL = scanner.nextLine();
            if (registeredServiceURL.trim().isEmpty()) {
                registeredServiceURL = "http://localhost:8090/LoyaltyService?wsdl";
            }
